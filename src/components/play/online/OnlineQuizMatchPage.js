...
const OnlineQuizMatchPage = ({question, answers, onAnswer, answerCorrect, answerDisabled, buttonHidden, score, timeLeft, round, onStart}) => {
  ...
  return (
    <div className="container text-center">
      ...
      <div className="row">
        <div className="col-md-6">
          <button className={background(0)} disabled={answerDisabled} onClick={onAnswer}><h6>{answers[0]}</h6></button>
        </div>
        <div className="col-md-6">
          <button className={background(1)} disabled={answerDisabled}  onClick={onAnswer}><h6>{answers[1]}</h6></button>
        </div>
      </div>
      <div className="row">
        <div className="col-md-6">
          <button className={background(2)} disabled={answerDisabled} onClick={onAnswer}><h6>{answers[2]}</h6></button>
        </div>
        <div className="col-md-6">
          <button className={background(3)} disabled={answerDisabled} onClick={onAnswer}><h6>{answers[3]}</h6></button>
        </div>
      </div>
      <div className="row">
